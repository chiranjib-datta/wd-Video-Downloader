package com.wdc.mycloud.youtube.vget;
...
public class AppManagedDownload {
    private static String TAG="AppManagedDownload";
        ...
        public void run() {
            ...
            case DONE:
                ...
                for (VideoFileInfo d : videoinfo.getInfo()) {
                    ...
                    Log.d(TAG,String.format("file:%d - %s (%s)", dinfoList.indexOf(d), d.targetFile,
            ...
            case ERROR:
                ...
                if (dinfoList != null) {
                    for (DownloadInfo dinfo : dinfoList) {
                        Log.d(TAG,"file:" + dinfoList.indexOf(dinfo) + " - " + dinfo.getException() + " delay:"
                                + dinfo.getDelay());
                    }
                }
                break;
            case RETRYING:
                Log.d(TAG,videoinfo.getState() + " " + videoinfo.getDelay());

                if (dinfoList != null) {
                    for (DownloadInfo dinfo : dinfoList) {
                        Log.d(TAG,"file:" + dinfoList.indexOf(dinfo) + " - " + dinfo.getState() + " "
            ...
            case DOWNLOADING:
                ...
                if (now - 1000 > last) {
                    ...
                    for (VideoFileInfo dinfo : dinfoList) {
                        ...
                        Log.d(TAG,String.format("file:%d - %s %.2f %s (%s)", dinfoList.indexOf(dinfo),
    ...
    public static void download(String url,String fPath) {
        ...
        try {
            ...
            if (list != null) {
                for (VideoFileInfo d : list) {
                    ...
                    Log.d(TAG,"Download URL: " + d.getSource());
                }
            }
